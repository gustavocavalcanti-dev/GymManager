...
<div class="card">
    ...
    <form action="<?= $basePath ?>/professores/store" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="especialidade" id="especialidade" class="form-control" value="<?= htmlspecialchars($dados['especialidade'] ?? '') ?>" placeholder="Ex: Musculação, Pilates, Crossfit">
        </div>
